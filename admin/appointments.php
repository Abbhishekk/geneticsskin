      ...
      <div class="card">
        <div class="card-body">
          ...
          <?php
            ...
            else if (isset($_GET["treatment"]) && $_GET["msg"] == "Rescheduled successfully") {
              ...
              if (mysqli_num_rows($aesthatic) > 0) {
                ...
                while ($row = mysqli_fetch_assoc($aesthatic)) {
                  ...
                  echo "<tr>
                        ...
                        <td><a href='aesthetic_appoint_action.php?cancel&id=$row[id]' class='btn btn-danger'>Cancel</a></td>
                      </tr>";
                  $sr++;
                }
              }
