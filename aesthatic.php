...
<body class=""  >
    <div class=" overflow-x-hidden ">
        ...
        <section class="">
            ...
            <div class="relative w-full glide-01 ">
                ...
                <div class="absolute top-[50%] left-[5%] bg-white p-5 rounded-xl bg-opacity-20 backdrop-filter backdrop-blur-md">
                                <h3 class="text-[#452464] text-sm animate-pulse" data-aos="fade-right">ADVANCED CARE
                                </h3>
                                <h1 class="text-[#452464] text-5xl" data-aos="fade-left">GET THE BEST Aesthatic <br>
                                    TREATMENTS</h1>
        ...
        <div class="flex flex-col justify-center items-center md:m-20 m-5">
            <p class="text-[#452464] text-3xl font-bold text-center mb-10" data-aos="fade-up">Aesthatics</p>
            <div class="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-5">
                ...
                <div class="card  mb-5 overflow-hidden">
                    <a href="aesthatics_item.php?id=<?php echo $row["id"]?>">
